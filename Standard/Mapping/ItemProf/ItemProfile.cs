    ...
    public class ItemProfile:Profile
    {
        public ItemProfile()
        {
            ...
            CreateMap<ItemDto, Item>()
                .ForMember(dest => dest.CatFkNavigation, opt => opt.Ignore()) 
                .ForMember(dest => dest.UniteFkNavigation, opt => opt.Ignore()) 
                .ForMember(dest => dest.SubFkNavigation, opt => opt.Ignore())
                .ReverseMap();
